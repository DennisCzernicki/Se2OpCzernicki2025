package business.businessSportverein;
...
public class SportvereineModel implements Observable {
	...
	private ArrayList<Sportverein> sportverein = new  ArrayList<Sportverein>();
	...
	public void nehmeSportvereinAuf(String name, String ort, int anzahlMitglieder, int anzahlEhemaligerMitglieder,
		...
		this.sportverein.add(new Sportverein(name, ort, anzahlMitglieder, anzahlEhemaligerMitglieder, sportarten));
		notifyObserver();
	...
	public void leseAusCsvDatei() throws java.io.IOException {
		...
		this.sportverein.add(new Sportverein(zeile[0], zeile[1], Integer.parseInt(zeile[2]), Integer.parseInt(zeile[3]),
				zeile[4].split("_")));
	...
	public void schreibeSportvereineInCsvDatei() throws IOException {
		...
		for(Sportverein sportverein : this.getSportverein()) {
	...
	public void addSportverein(Sportverein sportverein) {
		this.sportverein.add(sportverein);
		notifyObserver();
	}

	public ArrayList<Sportverein> getSportverein() {
		return sportverein;
	}
